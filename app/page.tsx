...
export default function Home() {
 const [timeLeft, setTimeLeft] = useState({ days: 0, hours: 0, minutes: 0, seconds: 0 });
  ...
  return (
    <div className="min-h-screen bg-pink-50 flex flex-col items-center justify-center p-[30px] text-center">
      ...
      <p className="text-[18px] text-gray-700 mb-[20px]">Кропивницький, ресторан Lokacia</p>
      ...
      <a href="https://www.google.com/maps/place/%D0%90%D0%9B%D0%91%D0%95%D0%9D%D0%90,+%D0%9A%D0%90%D0%A4%D0%95/@48.4974385,32.2124611,509m/data=!3m1!1e3!4m9!1m2!2m1!1z0LrQsNGA0YLQsA!3m5!1s0x40d042f09438ee97:0x898863c61b6c1644!8m2!3d48.4980481!4d32.2141402!16s%2Fg%2F1q2vwkn_p?entry=ttu&g_ep=EgoyMDI1MDUxMy4xIKXMDSoJLDEwMjExNDU1SAFQAw%3D%3D"
        ...
        className="bg-pink-300 text-white px-[24px] py-[10px] rounded-[10px] mb-[16px] hover:bg-pink-400 transition"
      >
        Показати на карті
      </a>
      ...
      <p className="text-[14px] text-gray-600 mt-[30px] max-w-[280px]">
